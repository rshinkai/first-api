...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should show user with products" do
  ...
  test "should create user" do
    assert_difference('User.count') do
      post api_v1_users_url, params: { user: { email: 'test@test.org', password: 'test1234' } }, as: :json
    end
  ...
  test "should not create user" do
    assert_no_difference('User.count') do
      post api_v1_users_url, params: { user: { email: @user.email, password: 'test1234'}}, as: :json
    end
